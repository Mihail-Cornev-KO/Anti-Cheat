...
void Discord::Update(bool inGame)
{
	...
	if (inGame) {
		...
		a = string_format("DeaFSoft v1098");
#elif(HOOK_SOURCE_VERSION == 1534)
		a = string_format("DeaFSoft v1534");
#elif(HOOK_SOURCE_VERSION == 2369)
		a = string_format("DeaFSoft v2369");
#else
		a = string_format("DeaFSoft System");
#endif
